...
$address = "contact@swatenergysystems.com";


// i.e. The standard subject will appear as, "You've been contacted by John Doe."

$e_subject = 'New message on SWAT: ' . $email . '.';
...
$e_body = "New message from $name  ($email, $telephone): $message";
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<p class='center'>Thank you for contacting us!</p>";
	echo "</div>";
	echo "</fieldset>";
